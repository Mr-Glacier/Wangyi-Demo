...
public class Test_ALL_Config {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 4138; i++) {
            ...
            ArrayList<Bean_T_WangYiConfig> BeanLsit = new ArrayList<>();
            for (int j = 0; j < CarItems2A.size() - CarItems2B.size(); j++) {

                String jsonStr = CarItems2A.get(j).attr("data-config").replace("'", "");
                ...
                BeanLsit.add(bean_t_wangYiConfig);
                //读配置再来一个循环
            }


            Elements TitleItems = document.select("");
