...
public class Test_One_Config {
    ...
    public static void main(String[] args) throws NoSuchFieldException, IllegalAccessException {
        ...
        String path = "F:/A_网易数据/Config页面/" + 0 + ".text";
...
//            System.out.println("B  "+ConfigDateItems3B.size());
            ...
            for (int j = 0; j < ConfigDateItems3A.size() - ConfigDateItems3B.size(); j++) {
                ...
                System.out.println("++++++++++++++++++++++++++++++++++++++");
                System.out.println(ConfigList.get(j).getC_VersionID());
                System.out.println(titleName + "  " + date);



                    Class c = ConfigList.get(j).getClass();
                    System.out.println(titleName);
                    field = c.getDeclaredField(columnMap.get(titleName.replace("\n","")));
...
//                Class C = ConfigList.get(j).getClass();
//                System.out.println(titleName);
//                field = C.getDeclaredField(columnMap.get(titleName));
//                field.setAccessible(true);
//                field.set(ConfigList.get(j),date);
